...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, ListOrdered, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'watchlist', labelKey: 'layout.nav.watchlist', to: '/watchlist', icon: ListOrdered },
